          ...
          <div class="log_log">
            <form action="javascript:void(0);" method="post" class="login formSubmit" id="login_form">
              ...
              <div class="form-group" style="position: relative;">
                ...
                <input type="password" class="form-control hny_frm checking input_check  " value="" placeholder="Password" name="userpassword" id="logInPassword" value="">
              ...
              <div class="forget">
                <a class="font-xs color-gray-500 mt-3" href="forget_password.php" style="text-align: end; display: block;">Forgot your password?</a>
              </div>


              <div class="d-flex m-auto justify-content-between log_reg">

                <button type="submit" class="btn common-btn text-center mt-3" id="lg_btn">Login</button>

              </div>

              <h5 class="mt-5 font-xs text-center">Don't have an account? <a href="javascript:;" class="registerfrm signup">Sign Up</a></h5>
            </form>
          </div>
